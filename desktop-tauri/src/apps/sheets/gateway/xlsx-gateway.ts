...
/// path.
export async function assembleWithJsZip(source: Uint8Array, plan: MutationPlan): Promise<XlsxMutation> {
...
export async function readBasicWorkbook(buffer: Uint8Array): Promise<ImportedXlsx> {
