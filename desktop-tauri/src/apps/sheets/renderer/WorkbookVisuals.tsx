            ...
            <input
              ...
              onChange={(event) =>
                setRanges((previous) => ({
                  ...
                  [String(index)]: {
                    categories: '',
                    // Partial cast: the desktop-tauri tsconfig lacks
                    // noUncheckedIndexedAccess, so the spread no longer reads
                    // as optional and TS2783 fires (upstream compiles stricter).
                    ...(previous[String(index)] as Partial<SeriesRangeInput> | undefined),
