...
import { AGENT_TOOLS, executePdfTool, type PdfAiDeps } from '../src/apps/pdf/renderer/ai/tools'
import type { SearchIndex } from '../src/apps/pdf/renderer/search'
import type { FormValueInput } from '../src/apps/pdf/shared/ipc'
