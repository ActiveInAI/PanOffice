...
import { blocksToPmDoc, pmDocToSavePlan, type PmNode } from '../../src/apps/docs/renderer/editor/convert'
import { applyRevisionsBy, collectRevisions } from '../../src/apps/docs/renderer/editor/revisions'
import { executeTool } from '../../src/apps/docs/renderer/ai/tools'
...
async function createEditor(withText = false) {
  const { editorExtensions } = await import('../../src/apps/docs/renderer/editor/extensions')
