...
import {
  ...
  parseCsv,
  sniffDelimiter,
} from '../../src/apps/sheets/gateway/csv-import'
...
function encodeWith(text: string, charset: string): Uint8Array {
...
const gbkBytes = (text: string): Uint8Array => encodeWith(text, 'gb18030')
const shiftJisBytes = (text: string): Uint8Array => encodeWith(text, 'shift_jis')
