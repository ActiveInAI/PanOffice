...
export async function buildCompatibilityFixture(): Promise<Uint8Array> {
  const zip = new JSZip()
...
export async function buildEditFixture(): Promise<Uint8Array> {
  const zip = new JSZip()
...
export async function buildStructureFixture(): Promise<Uint8Array> {
  const zip = new JSZip()
...
export async function buildSheetsFixture(): Promise<Uint8Array> {
  const zip = new JSZip()
