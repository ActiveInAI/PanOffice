...
// vitest cwd is desktop-tauri; the ported renderer lives under src/apps/sheets
const read = (rel: string) => readFileSync(join(process.cwd(), 'src/apps/sheets', rel), 'utf8')

const dialogSrc = read('renderer/InsertFunctionDialog.tsx')
const shellSrc = read('renderer/ExcelShell.tsx')
