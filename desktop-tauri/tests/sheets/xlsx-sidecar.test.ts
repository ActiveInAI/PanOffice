...
import { blankXlsxBuffer } from '../../src/apps/sheets/gateway/csv-import'
import { saveWorkbookViaSidecar } from '../../src/apps/sheets/gateway/xlsx-package-io'
...
import { workbookRangeResultSchema } from '../../src/apps/sheets/shared/desktop-api'
...
async function buildStructureFixture(): Promise<Uint8Array> {
  const zip = new JSZip()
  zip.file(
    'xl/workbook.xml',
    `<?xml version="1.0"?>
