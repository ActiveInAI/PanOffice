...
import type { SheetSparklineAddition } from '../../src/apps/sheets/gateway/xlsx-gateway'
import { applySparklineAdditions, SparklineAddError } from '../../src/apps/sheets/gateway/xlsx-sparkline'
