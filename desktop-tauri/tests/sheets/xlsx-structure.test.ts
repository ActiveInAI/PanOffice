...
import { applyCellEditsToXlsx, assertOnlyTouchedEntriesChanged } from '../../src/apps/sheets/gateway/xlsx-gateway'
import {
  applyStructuralOps,
...
} from '../../src/apps/sheets/gateway/xlsx-structure'
...
describe('structural save integration', () => {
  ...
  async function buildAnchoredFixture(): Promise<Uint8Array> {
    const zip = await JSZip.loadAsync(await buildStructureFixture())
