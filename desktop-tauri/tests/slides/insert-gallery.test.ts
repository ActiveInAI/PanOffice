...
import { CHART_GALLERY, SHAPE_GALLERY, SMARTART_GALLERY } from '../../src/apps/slides/renderer/insert-presets'
import {
  shapePreviewBox,
  shapePreviewPath,
  smartArtPreviewShapes,
} from '../../src/apps/slides/renderer/components/gallery-previews'
import { ChartKindThumb } from '../../src/apps/slides/renderer/components/ChartTypeDialog'
