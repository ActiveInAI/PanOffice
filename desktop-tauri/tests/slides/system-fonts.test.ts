...
vi.mock('../../src/apps/slides/main/shaped-metrics', () => ({
  initShapedMetrics: () => {},
  shapedMeasure: () => null,
  shapedFamily: () => null,
}))

import { createSystemFontMetrics, ensureSystemFontsReady } from '../../src/apps/slides/main/fonts'

beforeAll(() => ensureSystemFontsReady())
