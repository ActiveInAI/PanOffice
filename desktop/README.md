...
> **Fork notice.** This is the PanOffice desktop suite, forked from
> [GenOffice](https://github.com/genspark-ai/genoffice) 0.5.1 (Apache-2.0,
> © Mainfunc, Inc.). "GenOffice" and "Genspark" are trademarks of Mainfunc —
> they appear below only in the preserved upstream README for attribution.
> PanOffice development happens in the repository root one level up
> (`../docs/ARCHITECTURE.md` describes the overall PanOffice design).
