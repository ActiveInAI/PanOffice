...
/** PanAI brand mark, kept inline so it renders crisply at device resolution. */
export function PanAiMark({ size = 18 }: { readonly size?: number }): ReactElement {
  return (
    <svg
    ...
    >
      <polygon
        points="48 8 55.65 29.52 76.28 19.72 66.48 40.35 88 48 66.48 55.65 76.28 76.28 55.65 66.48 48 88 40.35 66.48 19.72 76.28 29.52 55.65 8 48 29.52 40.35 19.72 19.72 40.35 29.52"
        fill="#f4c542"
      />
      <circle cx="48" cy="48" r="20" fill="#fff1bf" />
    </svg>
  )
}
