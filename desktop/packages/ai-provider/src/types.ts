...
export type AiProviderId = 'archgpt' | 'genspark' | 'anthropic' | 'gemini' | 'deepseek' | 'openai' | 'custom'
...
export interface AiProviderConfig {
  apiKey: string
  model: string
  /** only used by providers with a configurable endpoint (archgpt, custom); empty archgpt baseUrl falls back to ARCHGPT_DEFAULT_BASE_URL */
